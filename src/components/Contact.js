						...
						<div className="col-md-5">
							<div className="colorlib-feature colorlib-feature-sm animate-box" data-animate-effect="fadeInLeft">
								...
								<div className="colorlib-text">
									<p><a href="mailto:bhawsarshuham741@gmail.com">Bhawsarshubham741@gmail.com</a></p>
								</div>
							</div>
							...
							<div className="colorlib-feature colorlib-feature-sm animate-box" data-animate-effect="fadeInLeft">
								...
								<div className="colorlib-text">
									<p><a href="tel://">+91 9302811597</a></p>
								</div>
							</div>
						</div>
...
{/*             
            <div  style={{
                ...
                <a  href="https://www0tg0eELWuBlpEAw" target="youtube"><i classNameName="fa fa-youtube " style={{color:"#C0C0C0"}} ></i></a>
                                 
                                <p classNameName="w3-medium" style={{color:"#C0C0C0"}}>Developed by <a href="https://www.linkedin.com/in/shubham
         */}
