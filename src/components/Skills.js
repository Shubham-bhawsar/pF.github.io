...
class Skills extends Component {
    render() {
        return (
				...
				<div className="colorlib-narrow-content">
					...
					<div className="row">
						<div className="col-md-12 animate-box" data-animate-effect="fadeInLeft">
							<h3>On my way of acquiring new skills.</h3>
							<p>Level of confidence in various skills.</p>
						</div>
			...
			<div id="colorlib-counter" className="colorlib-counters" style={{backgroundImage: "url(images/img_bg_1.jpg)"}} data-stellar-background-ratio="5">
				...
				<div className="colorlib-narrow-content">
					...
					<div className="row">
						...
						<div className="col-md-4 text-center animate-box">
						<br/><span className="colorlib-counter js-counter" data-from="0" data-to="10" data-speed="5000" data-refresh-interval="50"></span>
							<span className="colorlib-counter-label"><br/>Plus projects</span>
						</div>
						<div className="col-md-4 text-center animate-box">
						<br/>	<span className="colorlib-counter js-counter" data-from="0" data-to="15" data-speed="5000" data-refresh-interval="50"></span>
							<span className="colorlib-counter-label"><br/>Plus courses</span>
						</div>
						{/* <div className="col-md-3 text-center animate-box">
							<span className="colorlib-counter js-counter" data-from="0" data-to="10" data-speed="1000" data-refresh-interval="50"></span>
